...
with Petstore(
    ...
    res = p_client.user.get_user_by_name(username="Zachery_Lubowitz15")
...
with Petstore(
    ...
    p_client.user.update_user(username="Dandre_Hand41", user={
        "id": 10,
        "username": "theUser",
        "first_name": "John",
        "last_name": "James",
...
with Petstore(
    ...
    res = p_client.user.delete_user(username="Demetris_Schmitt")
